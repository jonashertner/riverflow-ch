...
const SOURCES = [
  {
    ...
    links: [
      { label: 'LINDAS observations', url: 'https://lindas.admin.ch/query' },
      { label: 'hydrodaten station plots and units', url: 'https://www.hydrodaten.admin.ch/' },
    ],
  ...
  },
  {
    ...
    url: 'https://www.bfe.admin.ch/bfe/de/home/versorgung/digitalisierung-und-geoinformation/geoinformation/geodaten/wasser/statistik-der-wasserkraftanlagen.html',
    licence: 'opendata.swiss, attribution',
  ...
  },
  {
    ...
    licence: 'opendata.swiss, attribution',
    note: 'A historical basis for determining Q347, not a binding site decision. Art. 4(h) defines Q347 as a ten-year average; BAFU says model values are rough estimates that generally need local measurement. The canton determines the adequate residual flow.',
  },
  {
  ...
  {
    key: 'ice', layer: null,
    name: 'Six Swiss Glacier Inventories and glacier length change',
    holder: 'GLAMOS', cls: 'survey', cadence: 'the inventories are episodic; lengths annual', live: false,
    url: 'https://doi.glamos.ch/',
    links: [
      { label: 'SGI1850', url: 'https://doi.glamos.ch/data/inventory/inventory_sgi1850_r1992.html' },
      { label: 'SGI1931', url: 'https://doi.glamos.ch/data/inventory/inventory_sgi1931_r2022.html' },
      { label: 'SGI1973', url: 'https://doi.glamos.ch/data/inventory/inventory_sgi1973_r1976.html' },
      { label: 'SGI2010', url: 'https://doi.glamos.ch/data/inventory/inventory_sgi2010_r2010.html' },
      { label: 'SGI2016', url: 'https://doi.glamos.ch/data/inventory/inventory_sgi2016_r2020.html' },
      { label: 'SGI2023', url: 'https://doi.glamos.ch/data/inventory/inventory_sgi2023_r2026.html' },
      { label: 'length change', url: 'https://doi.glamos.ch/data/lengthchange/lengthchange_2025_r2025.html' },
    ],
    ...
    note: 'Six linked inventories describe 1850, 1931, 1973, 2010, 2016 and 2023; a seventh linked dataset supplies annual tongue-length change. The 2023 inventory was released in 2026 and describes acquisition years 2021–2024, centred on 2023.',
  },
  {
  ...
  },
  {
    ...
    url: 'https://map.geo.admin.ch/?layers=ch.bafu.grundwasserkoerper',
  ...
  },
  {
    ...
    holder: 'BAFU', cls: 'register', cadence: 'irregular', live: false,
    url: 'https://map.geo.admin.ch/?layers=ch.bafu.wasser-teileinzugsgebiete_2',
    licence: 'FSDI general terms of use, free use with source attribution',
    fixed: null,
  ...
  },
  {
    ...
    links: [
      { label: '10m lakes', url: 'https://www.naturalearthdata.com/downloads/10m-physical-vectors/10m-lakes/' },
      { label: '10m countries', url: 'https://www.naturalearthdata.com/downloads/10m-cultural-vectors/10m-admin-0-countries/' },
    ],
...
for (const s of SOURCES) {
  ...
  sources.push({
    ...
    live: !!s.live, url: s.url, links: s.links ?? [], licence: s.licence, note: s.note,
